...
(function (root) {
  ...
  const PATHS = {
    ...
    chevronDown: "M7.4 9.6 12 14.2l4.6-4.6L18 11l-6 6-6-6 1.4-1.4Z",
    ...
    gif: "M4 5h16a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1Zm4.5 4.2a2.8 2.8 0 1 0 2.3 4.4v-1.9H8.6v1.2h1v.3a1.6 1.6 0 1 1-.1-2.7l.9-.9a2.8 2.8 0 0 0-1.9-.4ZM12.6 9v6h1.3V9h-1.3Zm2.6 0v6h1.3v-2.4h2v-1.2h-2V10.2h2.3V9h-3.6Z",
    ...
    open: "M5 3h6v2H6v13h13v-5h2v6a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1Zm9 0h7v7h-2V6.4l-7.3 7.3-1.4-1.4L17.6 5H14V3Z",
